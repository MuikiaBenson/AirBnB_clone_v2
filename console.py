#!/usr/bin/python3
"""This serves as the AirBnB console"""
import cmd
import re
...
class HBNBCommand(cmd.Cmd):
    """this class serves as the starting point for the command interpreter
    """
    prompt = "(hbnb) "
    ...
    def do_destroy(self, line):
        """Deletes an instance based on the class name and corresponding id
        Exceptions:
            SyntaxError: when there is no args given
            NameError: when there is no object taht has the name
            IndexError: when there is no id given
